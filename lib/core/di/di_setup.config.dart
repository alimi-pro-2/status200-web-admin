...
import 'package:alimipro_mock_data/core/di/app_module.dart' as _i20;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.singleton<_i16.GetPersonalPunchLogsUseCase>(() =>
        _i16.GetPersonalPunchLogsUseCase(
            logDataRepository: gh<_i11.LogDataRepository>()));
    gh.factory<_i17.StudentPunchLogViewModel>(() =>
        _i17.StudentPunchLogViewModel(
            personalPunchLogsUseCase: gh<_i16.GetPersonalPunchLogsUseCase>()));
    gh.factory<_i18.NoticeViewModel>(
        () => _i18.NoticeViewModel(noticeUseCase: gh<_i15.GetNoticeUseCase>()));
